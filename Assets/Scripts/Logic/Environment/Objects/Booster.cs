...
namespace GachiBird.Environment.Objects
{
    public sealed class Booster : IBooster
    {
        ...
        public Booster(ICollider2DListener checkpointCollider2DListener, ICollider2DListener boosterCollider2DListener, 
            SpriteRenderer spriteRenderer)
        {
            CheckpointCollider2DListener = checkpointCollider2DListener;
            _spriteRenderer = spriteRenderer;

            boosterCollider2DListener.OnTrigger += (_, __) => 
                PickedUp?.Invoke(spriteRenderer.gameObject, this, _boosterInfo);
        }
