...
namespace AreYouFruits.Common.Collections.GenericExtensions
{
    ...
    {
        public static TDictionary Foreach<TKey, TValue, TDictionary>(this TDictionary dictionary, Action<TKey, TValue> action)
        ...
        public static TReadOnlyCollection For<T, TReadOnlyCollection>(this TReadOnlyCollection array, Action<int> action)
        ...
        public static void SafeAddToValueCollection<TKey, TValue, TCollection, TDictionary>(this TDictionary dictionary, TKey key, TValue value)
